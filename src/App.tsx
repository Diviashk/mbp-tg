...
function App() {
  ...
  /* ===========================================================
     TELEGRAM WEBAPP: ENSURE EXPANDED + CORRECT VIEWPORT HEIGHT
     =========================================================== */
  useEffect(() => {
    ...
    try {
      ...
      // Ensure responsiveness on viewport change
      tg.onEvent('viewport_changed', () => {
        tg.expand();
      });
    } catch (err) {
      console.warn("Telegram WebApp initialization issue:", err);
    }
  }, []);

  /* ===========================================================
     LOAD EMPLOYEE ONCE WHEN TELEGRAM USER IS READY
     =========================================================== */
  useEffect(() => {
    const loadEmployee = async () => {
      ...
      try {
        ...
        setError(
          'Could not load your employee profile. Please contact your manager to link your Telegram account.'
        );
      } finally {
        setIsLoading(false);
      }
  ...
  /* ===========================================================
     ERROR SCREEN: ACCOUNT NOT LINKED
     =========================================================== */
  if (error && !employee) {
    return (
  ...
  return (
    <div className="app-container">
      {currentScreen === 'home' && (
        <HomeScreen employee={employee} onNavigate={handleNavigate} />
      )}
